...
class Calculator extends React.Component {
    ...
    processInput(value){
        switch(value ) {
            ...
            case 'Clear': {
                // if it's clear sign, just clean our question and answer in the state
            ...
            <div>
                ...
                <div className="mainCalc">
                    ...
                    <div className='button-row'>
                        {/* <ImageButton label={'Clear'} img={'/clear.png'} handleClick = {this.handleClick} />  */}
                        {/* <Button img='./public/clear.png' handleClick = {this.handleClick}/> */}
